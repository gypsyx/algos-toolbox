from week4.binary_search import binary_search, binary_search_single_item
from week4 import binary_search_duplicates as bsd

def test_binary_search_single_item():
...
def test_binary_search_single_item_large_input():
    keys = []
...
def test_binary_search_failed_test():
    input = "1 5 8 12 13"
...
def test_binary_search_large_input(benchmark):
    keys = []
    for i in range(1, 30000+1):
        keys.append(i)
...
def test_binary_search_duplicates_large_input_fast(benchmark):
    keys = [10**9]*15001
...
def test_binary_search_duplicates_large_input_slow(benchmark):
    keys = [10**9]*15001
    for i in range(1,15001):
        keys.append(10**9 + i)
